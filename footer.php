		...
		<div class="container">
			...
			<div class="footer-cpy text-center">
				...
				<div class="w3layouts-agile-copyrightbottom">
					<p> Jimdel-Edu Responsive Blog <?php $current=date("Y"); print_r($current);?> | Website Design Blog
						<a href="https://www.youtube.com/channel/UCiC5-n85_UzJs7C1FvFl-fg/videos/">Jimdel-Edu</a>
					</p>
